  ...
  return (
    <main className="flex min-h-screen flex-col items-start p-10 gap-6">
      <div>
        ...
        {!user ? (
          <p className="text-sm text-[var(--color-fg-muted)]">You are not signed in.</p>
        ) : (
          <div className="mt-4">
      ...
      <section className="w-full max-w-2xl rounded-md border p-4">
        ...
        <p className="text-sm text-[var(--color-fg-muted)] mt-2">This section will show your reservations once the API is implemented.</p>
      </section>
    </main>
  );
}
